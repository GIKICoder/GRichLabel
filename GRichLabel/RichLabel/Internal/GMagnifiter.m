...
@interface _GTextMagnifierCaret : GMagnifiter {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end

@implementation _GTextMagnifierCaret
...
- (GTextMagnifierType)type {
    return GTextMagnifierTypeCaret;
}
...
+ (UIImage *)coverImage {
    ...
    dispatch_once(&onceToken, ^{
        ...
        CGPathRef strokePath = CGPathCreateWithEllipseInRect(GetCGRectPixelHalf(rect), NULL);
        ...
        CGContextSaveGState(context); {
            ...
            CGContextSetLineWidth(context, GTextCGFloatFromPixel(1));
...
@interface _GTextMagnifierRanged : GMagnifiter {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end
...
@implementation _GTextMagnifierRanged
#define kMultiple 1.2
#define kSize CGSizeMake(141, 60)
#define kPadding GTextCGFloatPixelHalf(6.0)
#define kRadius 6.0
#define kHeight 32.0
#define kArrow 14.0
...
- (GTextMagnifierType)type {
    return GTextMagnifierTypeRanged;
}
...
#pragma mark - GMagnifiter @implementation

@implementation GMagnifiter

+ (id)magnifierWithType:(GTextMagnifierType)type {
    switch (type) {
        case GTextMagnifierTypeCaret :return [_GTextMagnifierCaret new];
        case GTextMagnifierTypeRanged :return [_GTextMagnifierRanged new];
    }
    return nil;
}
...
- (instancetype)initWithFrame:(CGRect)frame {
    // class cluster
    if ([self isMemberOfClass:[GMagnifiter class]]) {
